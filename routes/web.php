...
use App\Http\Controllers\Auth\RegisterController;
use App\Http\Controllers\CutiMusyrifController;
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
=======
use App\Http\Controllers\MusyrifController as ControllersMusyrifController;
...
Auth::routes();
Route::post('/submit-form', [LoginController::class, 'submitForm']);
