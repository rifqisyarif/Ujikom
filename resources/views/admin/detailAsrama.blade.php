            ...
            <div class="container-fluid">
                ...
                <div id="form-wrapper" class="row">
                    <form class="d-flex flex-column gap-3" action="{{ route('dashboard') }}">
                        <div class="d-flex align-items-center">
                            <label class="mb-0 mr-2"><b>Hari Piket: </b></label>
                            <select class="form-control col-xl-4 col-md-7">
                    ...
                    <div class="card mt-4 col-xl-4" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <div class="detail2 d-flex justify-content-between">
                                <div>
                                    <h6 class="card-title mb-0 d-flex ">Hari piket: <p class="ml-2">Senin</p>
                                    </h6>
                                    <h6 class="card-title mb-0 d-flex ">Kelas: <p class="ml-2">12 RPL Karir</p>
                                    </h6>
                                </div>
                                <div class="div">
                                    <a href="#" class="btn btn-primary btn-sm">Sudah Datang</a>
                                </div>
                            </div>
